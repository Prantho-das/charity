        ...
        <div class="item active">
            ...
            <div class="container">
                ...
                <div class="carousel-caption">
                    ...
                    <button id="bKash_button" onclick="BkashPayment()" class="btn btn-lg btn-secondary hidden-xs">DONATE
                        NOW</button>
...
<script type="text/javascript">
    ...
    function createPayment(request) {
        ...
        request['amount'] =
            "{{ Session::get('bkash') ? Session::get('bkash')['invoice_amount'] : 50 }}"; // max two decimal points allowed
