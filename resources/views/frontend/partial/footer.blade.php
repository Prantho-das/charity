<footer class="main-footer">
    ...
    <div class="footer-bottom">
        ...
        <div class="container text-right">
            TarunyarJoy @ copyrights - by <a href="http://www.tarunyarjoy.org" target="_blank">TarunyarJoy</a>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3><span style="color:yellowgreen;"> বিকাশ নম্বর </span> 01799943763 <sup>PERSONAL</sup></h3>
